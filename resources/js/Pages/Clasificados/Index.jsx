        ...
        <div>
            <div className=' flex justify-center'>
                <Card className="w-full max-w-4xl "> 
                    <h2 className="text-center block text-md font-medium text-blue-600 dark:text-gray-300 mb-1 ">Digite su <strong>aviso clasificado.</strong> Se publicará una vez sea aprobado por la administración</h2>
                    <span className="text-center block text-sm font-medium text-blue-700 dark:text-gray-300 mb-1 ">Recuerde que el aviso se publicará por 30 días, luego de ese tiempo se eliminará automáticamente.</span>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 ">                    
                        <form onSubmit={handleSubmit} className="space-y-4 w-full">
                            ...
                            <div className="md:col-span-2">
                                <TextAreaInput label="Texto del aviso. Max 500 caracteres." name="cla_detalle" value={formData.cla_detalle} 
                                onChange={handleChange} maxlength="500" 
                                rows={2} cols={140}   placeholder="Información relevante, Max 500 caracteres." />
                            </div>                       
