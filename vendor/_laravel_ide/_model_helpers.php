...
namespace App\Models {
    ...
    /**
     * App\Models\Contactos
     *
     * @property string $con_soportepdf
     * @property string $con_mensaje
     * @property string $con_telefono
     * @property string $con_email
     * @property string $con_tipopqr
     * @property string $con_apellidos
     * @property string $con_nombres
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<Contactos>|Contactos whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Contactos>|Contactos whereConNombres($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Contactos>|Contactos whereConApellidos($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Contactos>|Contactos whereConTipopqr($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Contactos>|Contactos whereConEmail($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Contactos>|Contactos whereConTelefono($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Contactos>|Contactos whereConMensaje($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Contactos>|Contactos whereConSoportepdf($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Contactos>|Contactos newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Contactos>|Contactos newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Contactos>|Contactos query()
     ...
     */
    class Contactos extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property int $id
     * @property-read \App\Models\Conjunto $conjunto
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \Illuminate\Notifications\DatabaseNotification> $notifications
     * @property-read int|null $notifications_count
     * @method static \Illuminate\Database\Eloquent\Builder<User>|User whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<User>|User whereConjuntoId($value)
