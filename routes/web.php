...
Route::get('/avisos', [AvisosController::class, 'index'])->middleware(['auth', 'verified'])->name('avisos');
...
Route::get('/tramites', [TramiteController::class, 'indexVer'])->middleware(['auth', 'verified'])->name('tramites.indexVer');
Route::get('/tramites/{op}', [TramiteController::class, 'index'])->name('tramites.index');
...
Route::get('/contactos', [ContactosController::class, 'index'])->middleware(['auth', 'verified'])->name('contactos');
...
// Define el manejo de datos del conjunto de propietarios

Route::get('/conjunto', [ConjuntoController::class, 'index'])->middleware(['auth', 'verified'])->name('conjunto');
